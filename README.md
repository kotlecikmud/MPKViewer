...
2.  **`processed_dataset/`:** This directory contains historical data from 2022, listing all bus and tram lines.
...
The project includes tests for the scraper to ensure its functionality. To run the tests, use `pytest`:

```bash
python3 -m pytest test_scraper.py
```
